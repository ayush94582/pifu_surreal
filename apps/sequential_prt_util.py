...
def testPRT(obj_path):
    ...
    #render_prt_ortho(obj_path, PRT, F, '/home/ayushagarwal/PIFu/final_pifu_train', frame_name, subject_name, video_name, shs, rndr)
...
if __name__ == '__main__':
    ...
    obj_list = glob.glob("/home/ayushagarwal/PIFu/pifu_small_train/*/*/frame*.obj")
